  ...
  var b = class extends HTMLElement {
    ...
    static getPropertyDescriptor(t4, s3, i5) {
      ...
      return { get() {
        ...
        h4.call(this, s4), this.requestUpdate(t4, r6, i5);
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var V = (t4, i5) => {
    ...
    for (let i6 = 0; i6 < s3; i6++) {
      const s4 = t4[i6];
      let a3, u3, d3 = -1, y4 = 0;
      for (; y4 < s4.length && (c4.lastIndex = y4, u3 = c4.exec(s4), null !== u3); ) y4 = c4.lastIndex, c4 === f2 ? "!--" === u3[1] ? c4 = v : void 0 !== u3[1] ? c4 = _ : void 0 !== u3[2] ? ($.test(u3[2]) && (r6 = RegExp("</" + u3[2], "g")), c4 = m) : void 0 !== u3[3] && (c4 = m) : c4 === m ? ">" === u3[0] ? (c4 = r6 ?? f2, d3 = -1) : void 0 === u3[1] ? d3 = -2 : (d3 = c4.lastIndex - u3[2].length, a3 = u3[1], c4 = void 0 === u3[3] ? m : '"' === u3[3] ? g : p2) : c4 === g || c4 === p2 ? c4 = m : c4 === v || c4 === _ ? c4 = f2 : (c4 = m, r6 = void 0);
      const x3 = c4 === m && t4[i6 + 1].startsWith("/>") ? " " : "";
      l3 += c4 === f2 ? s4 + n3 : d3 >= 0 ? (o5.push(a3), s4.slice(0, d3) + e3 + s4.slice(d3) + h2 + x3) : s4 + h2 + (-2 === d3 ? i6 : x3);
    }
  ...
  function S2(t4, i5, s3 = t4, e5) {
    if (i5 === T) return i5;
    let h4 = void 0 !== e5 ? s3._$Co?.[e5] : s3._$Cl;
    const o5 = c3(i5) ? void 0 : i5._$litDirective$;
    return h4?.constructor !== o5 && (h4?._$AO?.(false), void 0 === o5 ? h4 = void 0 : (h4 = new o5(t4), h4._$AT(t4, s3, e5)), void 0 !== e5 ? (s3._$Co ??= [])[e5] = h4 : s3._$Cl = h4), void 0 !== h4 && (i5 = S2(t4, h4._$AS(t4, i5.values), h4, e5)), i5;
  }
  var M = class {
    constructor(t4, i5) {
    ...
    u(t4) {
      ...
      C.currentNode = e5;
      let h4 = C.nextNode(), o5 = 0, n5 = 0, l3 = s3[0];
      for (; void 0 !== l3; ) {
        if (o5 === l3.index) {
          let i6;
          2 === l3.type ? i6 = new R(h4, h4.nextSibling, this, t4) : 1 === l3.type ? i6 = new l3.ctor(h4, l3.name, l3.strings, this, t4) : 6 === l3.type && (i6 = new z(h4, this, t4)), this._$AV.push(i6), l3 = s3[++n5];
        }
  ...
  var R = class _R {
    ...
    k(t4) {
      ...
      const i5 = this._$AH;
      let s3, e5 = 0;
      for (const h4 of t4) e5 === i5.length ? i5.push(s3 = new _R(this.O(l2()), this.O(l2()), this, this.options)) : s3 = i5[e5], s3._$AI(h4), e5++;
  ...
  var k = class {
    ...
    constructor(t4, i5, s3, e5, h4) {
      this.type = 1, this._$AH = E, this._$AN = void 0, this.element = t4, this.name = i5, this._$AM = e5, this.options = h4, s3.length > 2 || "" !== s3[0] || "" !== s3[1] ? (this._$AH = Array(s3.length - 1).fill(new String()), this.strings = s3) : this._$AH = E;
    }
    _$AI(t4, i5 = this, s3, e5) {
      const h4 = this.strings;
      let o5 = false;
      if (void 0 === h4) t4 = S2(this, t4, i5, 0), o5 = !c3(t4) || t4 !== this._$AH && t4 !== T, o5 && (this._$AH = t4);
      else {
        const e6 = t4;
        let n5, r6;
        for (t4 = h4[0], n5 = 0; n5 < h4.length - 1; n5++) r6 = S2(this, e6[s3 + n5], i5, n5), r6 === T && (r6 = this._$AH[n5]), o5 ||= !c3(r6) || r6 !== this._$AH[n5], r6 === E ? t4 = E : t4 !== E && (t4 += (r6 ?? "") + h4[n5 + 1]), this._$AH[n5] = r6;
      }
      o5 && !e5 && this.j(t4);
    }
    j(t4) {
  ...
  var L = class extends k {
    constructor(t4, i5, s3, e5, h4) {
      super(t4, i5, s3, e5, h4), this.type = 5;
    }
    _$AI(t4, i5 = this) {
      if ((t4 = S2(this, t4, i5, 0) ?? E) === T) return;
      const s3 = this._$AH, e5 = t4 === E && s3 !== E || t4.capture !== s3.capture || t4.once !== s3.once || t4.passive !== s3.passive, h4 = t4 !== E && (s3 === E || e5);
      e5 && this.element.removeEventListener(this.name, this, s3), h4 && this.element.addEventListener(this.name, this, t4), this._$AH = t4;
    }
    handleEvent(t4) {
  ...
  var B = (t4, i5, s3) => {
    ...
    if (void 0 === h4) {
      ...
      e5._$litPart$ = h4 = new R(i5.insertBefore(l2(), t5), t5, void 0, s3 ?? {});
    }
  ...
  var A2 = async (t4, r6) => {
    let e5 = typeof r6 == "function" ? await r6(t4) : r6;
    if (e5) return t4.scheme === "bearer" ? `Bearer ${e5}` : t4.scheme === "basic" ? `Basic ${btoa(e5)}` : e5;
  };
  var R2 = { bodySerializer: (t4) => JSON.stringify(t4, (r6, e5) => typeof e5 == "bigint" ? e5.toString() : e5) };
  var U = (t4) => {
    switch (t4) {
      case "label":
        return ".";
  ...
  var O = ({ allowReserved: t4, explode: r6, name: e5, style: a3, value: i5 }) => {
    if (!r6) {
      let s3 = (t4 ? i5 : i5.map((l3) => encodeURIComponent(l3))).join(_2(a3));
      switch (a3) {
        case "label":
          return `.${s3}`;
        case "matrix":
    ...
    let o5 = U(a3), n5 = i5.map((s3) => a3 === "label" || a3 === "simple" ? t4 ? s3 : encodeURIComponent(s3) : y3({ allowReserved: t4, name: e5, value: s3 })).join(o5);
    return a3 === "label" || a3 === "matrix" ? o5 + n5 : n5;
  };
  var y3 = ({ allowReserved: t4, name: r6, value: e5 }) => {
    if (e5 == null) return "";
    if (typeof e5 == "object") throw new Error("Deeply-nested arrays/objects aren\u2019t supported. Provide your own `querySerializer()` to handle these.");
    return `${r6}=${t4 ? e5 : encodeURIComponent(e5)}`;
  };
  var q = ({ allowReserved: t4, explode: r6, name: e5, style: a3, value: i5 }) => {
    if (i5 instanceof Date) return `${e5}=${i5.toISOString()}`;
    if (a3 !== "deepObject" && !r6) {
      let s3 = [];
      Object.entries(i5).forEach(([f3, u3]) => {
        s3 = [...s3, f3, t4 ? u3 : encodeURIComponent(u3)];
      });
      let l3 = s3.join(",");
      switch (a3) {
        case "form":
    ...
    let o5 = D(a3), n5 = Object.entries(i5).map(([s3, l3]) => y3({ allowReserved: t4, name: a3 === "deepObject" ? `${e5}[${s3}]` : s3, value: l3 })).join(o5);
    return a3 === "label" || a3 === "matrix" ? o5 + n5 : n5;
  };
  var H2 = /\{[^{}]+\}/g;
  var B2 = ({ path: t4, url: r6 }) => {
    let e5 = r6, a3 = r6.match(H2);
    if (a3) for (let i5 of a3) {
      let o5 = false, n5 = i5.substring(1, i5.length - 1), s3 = "simple";
      n5.endsWith("*") && (o5 = true, n5 = n5.substring(0, n5.length - 1)), n5.startsWith(".") ? (n5 = n5.substring(1), s3 = "label") : n5.startsWith(";") && (n5 = n5.substring(1), s3 = "matrix");
      let l3 = t4[n5];
      if (l3 == null) continue;
      if (Array.isArray(l3)) {
        e5 = e5.replace(i5, O({ explode: o5, name: n5, style: s3, value: l3 }));
        continue;
      }
      if (typeof l3 == "object") {
        e5 = e5.replace(i5, q({ explode: o5, name: n5, style: s3, value: l3 }));
        continue;
      }
      if (s3 === "matrix") {
        e5 = e5.replace(i5, `;${y3({ name: n5, value: l3 })}`);
        continue;
      }
      let f3 = encodeURIComponent(s3 === "label" ? `.${l3}` : l3);
      e5 = e5.replace(i5, f3);
    }
    return e5;
  };
  var E2 = ({ allowReserved: t4, array: r6, object: e5 } = {}) => (i5) => {
    let o5 = [];
    if (i5 && typeof i5 == "object") for (let n5 in i5) {
      let s3 = i5[n5];
      if (s3 != null) {
        if (Array.isArray(s3)) {
          o5 = [...o5, O({ allowReserved: t4, explode: true, name: n5, style: "form", value: s3, ...r6 })];
          continue;
        }
        if (typeof s3 == "object") {
          o5 = [...o5, q({ allowReserved: t4, explode: true, name: n5, style: "deepObject", value: s3, ...e5 })];
          continue;
        }
        o5 = [...o5, y3({ allowReserved: t4, name: n5, value: s3 })];
      }
    }
    return o5.join("&");
  };
  var P2 = (t4) => {
    if (!t4) return "stream";
    let r6 = t4.split(";")[0]?.trim();
    if (r6) {
      if (r6.startsWith("application/json") || r6.endsWith("+json")) return "json";
      if (r6 === "multipart/form-data") return "formData";
      if (["application/", "audio/", "image/", "video/"].some((e5) => r6.startsWith(e5))) return "blob";
      if (r6.startsWith("text/")) return "text";
    }
  };
  var I2 = async ({ security: t4, ...r6 }) => {
    for (let e5 of t4) {
      let a3 = await A2(e5, r6.auth);
      if (!a3) continue;
      let i5 = e5.name ?? "Authorization";
      switch (e5.in) {
        case "query":
          r6.query || (r6.query = {}), r6.query[i5] = a3;
          break;
        case "cookie":
          r6.headers.append("Cookie", `${i5}=${a3}`);
          break;
        case "header":
        default:
          r6.headers.set(i5, a3);
          break;
      }
      return;
    }
  };
  var S3 = (t4) => W({ baseUrl: t4.baseUrl, path: t4.path, query: t4.query, querySerializer: typeof t4.querySerializer == "function" ? t4.querySerializer : E2(t4.querySerializer), url: t4.url });
  var W = ({ baseUrl: t4, path: r6, query: e5, querySerializer: a3, url: i5 }) => {
    let o5 = i5.startsWith("/") ? i5 : `/${i5}`, n5 = (t4 ?? "") + o5;
    r6 && (n5 = B2({ path: r6, url: n5 }));
    let s3 = e5 ? a3(e5) : "";
    return s3.startsWith("?") && (s3 = s3.substring(1)), s3 && (n5 += `?${s3}`), n5;
  };
  var C2 = (t4, r6) => {
    let e5 = { ...t4, ...r6 };
    return e5.baseUrl?.endsWith("/") && (e5.baseUrl = e5.baseUrl.substring(0, e5.baseUrl.length - 1)), e5.headers = x2(t4.headers, r6.headers), e5;
  };
  var x2 = (...t4) => {
    let r6 = new Headers();
    for (let e5 of t4) {
      if (!e5 || typeof e5 != "object") continue;
      let a3 = e5 instanceof Headers ? e5.entries() : Object.entries(e5);
      for (let [i5, o5] of a3) if (o5 === null) r6.delete(i5);
      else if (Array.isArray(o5)) for (let n5 of o5) r6.append(i5, n5);
      else o5 !== void 0 && r6.set(i5, typeof o5 == "object" ? JSON.stringify(o5) : o5);
    }
    return r6;
  };
  var h3 = class {
    ...
    exists(r6) {
      return this._fns.indexOf(r6) !== -1;
    }
    eject(r6) {
      let e5 = this._fns.indexOf(r6);
      e5 !== -1 && (this._fns = [...this._fns.slice(0, e5), ...this._fns.slice(e5 + 1)]);
    }
    use(r6) {
      this._fns = [...this._fns, r6];
    }
  };
  var T2 = () => ({ error: new h3(), request: new h3(), response: new h3() });
  var N2 = E2({ allowReserved: false, array: { explode: true, style: "form" }, object: { explode: true, style: "deepObject" } });
  var Q = { "Content-Type": "application/json" };
  var w2 = (t4 = {}) => ({ ...R2, headers: Q, parseAs: "auto", querySerializer: N2, ...t4 });
  var J = (t4 = {}) => {
    let r6 = C2(w2(), t4), e5 = () => ({ ...r6 }), a3 = (n5) => (r6 = C2(r6, n5), e5()), i5 = T2(), o5 = async (n5) => {
      let s3 = { ...r6, ...n5, fetch: n5.fetch ?? r6.fetch ?? globalThis.fetch, headers: x2(r6.headers, n5.headers) };
      s3.security && await I2({ ...s3, security: s3.security }), s3.body && s3.bodySerializer && (s3.body = s3.bodySerializer(s3.body)), (s3.body === void 0 || s3.body === "") && s3.headers.delete("Content-Type");
      let l3 = S3(s3), f3 = { redirect: "follow", ...s3 }, u3 = new Request(l3, f3);
      for (let p3 of i5.request._fns) u3 = await p3(u3, s3);
      let k2 = s3.fetch, c4 = await k2(u3);
      for (let p3 of i5.response._fns) c4 = await p3(c4, u3, s3);
      let m2 = { request: u3, response: c4 };
      if (c4.ok) {
        if (c4.status === 204 || c4.headers.get("Content-Length") === "0") return { data: {}, ...m2 };
        let p3 = (s3.parseAs === "auto" ? P2(c4.headers.get("Content-Type")) : s3.parseAs) ?? "json";
        if (p3 === "stream") return { data: c4.body, ...m2 };
        let b3 = await c4[p3]();
        return p3 === "json" && (s3.responseValidator && await s3.responseValidator(b3), s3.responseTransformer && (b3 = await s3.responseTransformer(b3))), { data: b3, ...m2 };
      }
      let g2 = await c4.text();
      try {
        g2 = JSON.parse(g2);
      } catch {
      }
      let d3 = g2;
      for (let p3 of i5.error._fns) d3 = await p3(g2, c4, u3, s3);
      if (d3 = d3 || {}, s3.throwOnError) throw d3;
      return { error: d3, ...m2 };
    };
    return { buildUrl: S3, connect: (n5) => o5({ ...n5, method: "CONNECT" }), delete: (n5) => o5({ ...n5, method: "DELETE" }), get: (n5) => o5({ ...n5, method: "GET" }), getConfig: e5, head: (n5) => o5({ ...n5, method: "HEAD" }), interceptors: i5, options: (n5) => o5({ ...n5, method: "OPTIONS" }), patch: (n5) => o5({ ...n5, method: "PATCH" }), post: (n5) => o5({ ...n5, method: "POST" }), put: (n5) => o5({ ...n5, method: "PUT" }), request: o5, setConfig: a3, trace: (n5) => o5({ ...n5, method: "TRACE" }) };
  };
  ...
  // Pages/Features/FetchData/FetchData.ts
                        ...
                        <div class="max-w-md mx-auto">
                            <div class="divide-y divide-gray-200">
                                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div class="mt-6">
                                        ${this.loading ? x`<p class="text-center text-gray-500">Loading...</p>` : this.error ? x`<p class="text-center text-red-500">Error loading data. Please try again later.</p>` : x`<forecast-list .forecasts=${this.forecasts}></forecast-list>`}
                                    </div>
                                </div>
                            </div>
                        </div>
