  ...
  var b = class extends HTMLElement {
    ...
    _$AK(t4, s3) {
      ...
      if (void 0 !== e5 && this._$Em !== e5) {
        const t5 = i5.getPropertyOptions(e5), r5 = "function" == typeof t5.converter ? { fromAttribute: t5.converter } : void 0 !== t5.converter?.fromAttribute ? t5.converter : u;
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  function S2(t4, i5, s3 = t4, e5) {
    ...
    return h3?.constructor !== o4 && (h3?._$AO?.(false), void 0 === o4 ? h3 = void 0 : (h3 = new o4(t4), h3._$AT(t4, s3, e5)), void 0 !== e5 ? (s3._$Co ??= [])[e5] = h3 : s3._$Cl = h3), void 0 !== h3 && (i5 = S2(t4, h3._$AS(t4, i5.values), h3, e5)), i5;
  }
  var M = class {
    constructor(t4, i5) {
  ...
  var k = class {
    ...
    _$AI(t4, i5 = this, s3, e5) {
      ...
      if (void 0 === h3) t4 = S2(this, t4, i5, 0), o4 = !c3(t4) || t4 !== this._$AH && t4 !== T, o4 && (this._$AH = t4);
        ...
        const e6 = t4;
        let n5, r5;
        for (t4 = h3[0], n5 = 0; n5 < h3.length - 1; n5++) r5 = S2(this, e6[s3 + n5], i5, n5), r5 === T && (r5 = this._$AH[n5]), o4 ||= !c3(r5) || r5 !== this._$AH[n5], r5 === E ? t4 = E : t4 !== E && (t4 += (r5 ?? "") + h3[n5 + 1]), this._$AH[n5] = r5;
      }
      o4 && !e5 && this.j(t4);
    }
    j(t4) {
  ...
  // Pages/Features/About.ts
  var About = class extends r4 {
    render() {
      return x`
            <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
                <h2 class="text-3xl font-bold text-emerald-600 mb-4">About</h2>
                <div class="space-y-4 text-gray-700">
                    <p class="text-lg">This is a web application that combines the power of Blazor with Lit
                        components.</p>
                    <p class="text-lg">Built with modern web technologies to create a fast and responsive user
                        experience.</p>
                </div>
            </div>
        `;
